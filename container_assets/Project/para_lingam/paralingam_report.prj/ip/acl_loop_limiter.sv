...
generate
    if (THRESHOLD_W+1-UPDATE_WIDTH > 0) begin
        assign valid_allow_update_extended = {{(THRESHOLD_W+1-UPDATE_WIDTH){valid_allow_update[UPDATE_WIDTH-1]}}, valid_allow_update};
    end else begin
        assign valid_allow_update_extended = valid_allow_update;
    end
endgenerate
