...
module const_lambda_B1_merge (
    ...
    output wire [31:0] out_c1_exe112,
    output wire [31:0] out_c3_exe113,
    ...
    assign out_acl_global_id_016 = in_acl_global_id_016_0;

    // out_acl_hw_wg_id19(GPOUT,13)
    assign out_acl_hw_wg_id19 = in_acl_hw_wg_id19_0;

    // out_c0_exe13(GPOUT,14)
    assign out_c0_exe13 = in_c0_exe13_0;

    // out_c0_exe26(GPOUT,15)
    assign out_c0_exe26 = in_c0_exe26_0;

    // out_c0_exe38(GPOUT,16)
    assign out_c0_exe38 = in_c0_exe38_0;

    // out_c1_exe112(GPOUT,17)
    assign out_c1_exe112 = in_c1_exe112_0;

    // out_c3_exe113(GPOUT,18)
    assign out_c3_exe113 = in_c3_exe113_0;
