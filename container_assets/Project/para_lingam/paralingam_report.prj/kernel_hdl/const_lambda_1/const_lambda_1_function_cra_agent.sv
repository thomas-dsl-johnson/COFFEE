...
module const_lambda_1_function_cra_agent (
    ...
    // avs_cra_readdatavalid(GPOUT,460)
    ...
    // dupName_12_NO_NAME_x(LOGICAL,365)
    ...
    // dupName_13_NO_NAME_x(LOGICAL,371)
    ...
    // dupName_14_NO_NAME_x(LOGICAL,377)
    ...
    // global_size_2(GPOUT,467)
    assign global_size_2 = global_size_2_bit_join_q;

    // dupName_17_address_ref_x(CONSTANT,396)
    assign dupName_17_address_ref_x_q = 5'b11110;
    ...
    // dupName_17_can_write_x(LOGICAL,397)
    ...
    // dupName_19_NO_NAME_x(LOGICAL,405)
    ...
    // dupName_18_NO_NAME_x(LOGICAL,401)
    ...
    // dupName_17_NO_NAME_x(LOGICAL,395)
