...
---------|--------|--------------|-------------------------------------|-------------------------------
    0x80 |      W |  reg16[63:0] |                  arg_num_cols[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0x88 |      W |  reg17[63:0] |          arg_accessor_partial[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0x90 |      W |  reg18[63:0] |         arg_accessor_partial1[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0x98 |      W |  reg19[63:0] |       arg_accessor_partial1[127:64] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xa0 |      W |  reg20[63:0] |         arg_accessor_partial2[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xa8 |      W |  reg21[63:0] |       arg_accessor_partial2[127:64] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xb0 |      W |  reg22[63:0] |         arg_accessor_partial4[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xb8 |      W |  reg23[63:0] |       arg_accessor_partial4[127:64] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xc0 |      W |  reg24[63:0] |           arg_accessor_scores[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xc8 |      W |  reg25[63:0] |          arg_accessor_scores6[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xd0 |      W |  reg26[63:0] |          arg_accessor_scores7[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0xd8 |      W |  reg27[63:0] |          arg_accessor_scores9[63:0] |                              
...
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_NUM_COLS_REG (0x80 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL_REG (0x88 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL1_0_REG (0x90 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL1_1_REG (0x98 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL2_0_REG (0xa0 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL2_1_REG (0xa8 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL4_0_REG (0xb0 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL4_1_REG (0xb8 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES_REG (0xc0 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES6_REG (0xc8 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES7_REG (0xd0 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES9_REG (0xd8 + CONST_LAMBDA_3_REGISTER_MAP_OFFSET)

/* Argument Sizes (bytes) */
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_NUM_COLS_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL1_0_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL1_1_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL2_0_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL2_1_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL4_0_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL4_1_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES6_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES7_SIZE (8)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES9_SIZE (8)

/* Argument Masks */
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_NUM_COLS_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL1_0_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL1_1_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL2_0_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL2_1_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL4_0_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_PARTIAL4_1_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES6_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES7_MASK (0xffffffffffffffffULL)
#define CONST_LAMBDA_3_REGISTER_MAP_ARG_ARG_ACCESSOR_SCORES9_MASK (0xffffffffffffffffULL)
