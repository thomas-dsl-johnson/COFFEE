...
localparam SUPPORTS_NOP= (STYLE=="BURST-NON-ALIGNED") || (STYLE=="BURST-COALESCED") ||  (STYLE=="PREFETCHING") || (STYLE=="PIPELINED") || (FORCE_NOP_SUPPORT==1);
localparam SUPPORTS_BURSTS=( (STYLE=="BURST-COALESCED") || (STYLE=="BURST-NON-ALIGNED") || (STYLE=="PREFETCHING"));
...
if(READ==0 || (STYLE!="BURST-COALESCED" && STYLE!="BURST-NON-ALIGNED"))
