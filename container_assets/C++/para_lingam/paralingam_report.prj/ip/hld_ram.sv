...
module hld_ram #(
    ...
    parameter      DEVICE_FAMILY,                   //legal values are: "Cyclone V", "Arria V", "Stratix V", "Cyclone 10 GX", "Arria 10", "Stratix 10", "Agilex 7", "Agilex 5"
    ...
    `ACL_PARAMETER_ASSERT_MESSAGE(DEVICE_FAMILY == "Cyclone V" || DEVICE_FAMILY == "Arria V" || DEVICE_FAMILY == "Stratix V" ||
        DEVICE_FAMILY == "Cyclone 10 GX" || DEVICE_FAMILY == "Arria 10" || DEVICE_FAMILY == "Stratix 10" || DEVICE_FAMILY == "Agilex 7" || DEVICE_FAMILY == "Agilex 5",
        "DEVICE_FAMILY must be \"Cyclone V\", \"Arria V\", \"Stratix V\", \"Cyclone 10 GX\", \"Arria 10\", \"Stratix 10\", \"Agilex 7\" or \"Agilex 5\"")
